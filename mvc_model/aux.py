...
if __name__ == '__main__':
    ...
    b.get_control_point_for_sample()
    # print(b._knots)
    print(b.R([-0.25, -0.3, -0.35], [0, 0, 0]))
    # print('{' + ','.join(['%ff' % x for x in b.normal_control_points.reshape(-1, )]) + '};')
    # print()

    # print(b.get_control_point_for_sample().shape)
    # print('{')
    # for i in b.get_control_point_for_sample().reshape(-1, ):
    #     print(i, end='f, ')
    # print('}')
